...
We are going to evaluate the accuracy over each of them, and select which performs better. In this case, we evaluate *accuracy*, although we know the problems related to imbalanced datasets.
